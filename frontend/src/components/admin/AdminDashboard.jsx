          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600">₹{stats.totalAmount}</p>
              </div>
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.successfulDonations}</p>
              </div>
              <div className="p-3 bg-green-100 rounded-lg">
                <svg className="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link to="/admin/registrations">
            <Card className="hover:shadow-xl transition-shadow cursor-pointer" hover={false}>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">View Registrations</h3>
            ...
            <Card className="hover:shadow-xl transition-shadow cursor-pointer" hover={false}>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Track all donation records</p>
                </div>
              </div>
            </Card>
          </Link>
